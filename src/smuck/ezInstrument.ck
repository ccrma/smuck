...
public class ezInstrument extends Chugraph
{
    ...
    fun int steal_voice()
    {
        ...
        Math.random2(0, _n_voices - 1) => int stolen_voice_index;
    ...
    {
        n => _n_voices;
        new int[_n_voices] @=> voice_in_use;
        new int[_n_voices] @=> voice_to_pitch;
    }
